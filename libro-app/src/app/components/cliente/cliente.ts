...
import { ClienteServise } from '../../services/cliente';
...
export class ClienteComponent implements OnInit {
  ...
  constructor(private clienteService: ClienteServise){ }
  ...
  editarCliente(cliente: Cliente): void{
    ...
    setTimeout(() => { 
      this.formularioCliente.nativeElement.scrollIntoView({behavior: 'smooth', blok: 'smooth'});
     }, 100);
  }
